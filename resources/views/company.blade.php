        ...
        <div class="container">
            ...
            <div class="row bg-main mx-md-0">
                ...
                <div class="col-md-4 pb-3">
                    <h6 class="font-weight-bold text-uppercase mt-3 py-2">Gà không lối thoát</h6>
                    <div class="col-11 shop-info px-0">
                        <ul>
                            <li><i class="fa fa-info-circle"></i><span><b>Giới thiệu</b> : gà Không lối thoát của HKD Hoàng Đặng Văn Tích lũy từ 100% lên tới 300%</span></li>
                            <li><i class="fa fa-map-marker"></i> <span>Số nhà 5B, ngõ 5, Ao Sen, Phường Mộ Lao, Quận Hà Đông, Thành phố Hà Nội</span></li>
                            <li><i class="fa fa-phone"></i> <span><a href="tel:0933471981">0933471981</a></span></li>
                            <li><i class="fa fa-internet-explorer"></i> <span><a href="http://donghanhviet.vn/news/523/377/Rom-ra-voi-mon-Ga-khong-loi-thoat/d" target="_blank" style="color: rgb(0, 123, 255);">
          donghanhviet.vn/news/523/377/Rom-ra-voi-mon-Ga-khong-loi-thoat/d</a>, <a href="news_detail_tpl?utm_source=zalo&amp;utm_medium=zalo&amp;utm_campaign=zalo&amp;zarsrc=30" target="_blank" style="color: rgb(0, 123, 255);">
          ews_detail_tpl?utm_source=zalo&amp;utm_medium=zalo&amp;utm_campaign=zalo&amp;zarsrc=30</a></span></li>
                            <li><i class="fa fa-id-card-o"></i> <span><b>ID BBI</b> : PHATTAI86</span></li>
                            <li><i class="fa fa-clock-o"></i> <span><b>Mở cửa</b> : 08:00 - 21:00 (Thứ 2
                          - Chủ nhật)</span></li>
